      ...
      <section className="bg-white/45 px-6 py-16 md:px-10 md:py-20">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-white/70 bg-white/70 p-5 shadow-xl shadow-[#075E54]/10 backdrop-blur-xl">
              <Camera className="mb-4 size-7 text-[#075E54]" />
              <p className="text-3xl font-extrabold">{galleryData.length}</p>
              <p className="mt-1 text-sm text-[#536761]">Gallery items</p>
            </div>
            <div className="rounded-lg border border-white/70 bg-white/70 p-5 shadow-xl shadow-[#075E54]/10 backdrop-blur-xl">
              <MapPinned className="mb-4 size-7 text-[#075E54]" />
      ...
      <section className="px-6 py-16 md:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            ...
            <Link
              href="/bangalore/"
              className="inline-flex min-h-[44px] items-center justify-center rounded-lg border border-white/70 bg-white/70 px-5 py-2 text-sm font-semibold text-[#075E54] backdrop-blur-xl transition hover:bg-[#EEF7F4]"
            >
              View Service Areas
            </Link>
          </div>
