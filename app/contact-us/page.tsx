        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_1fr] lg:items-center">
          <div>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              <div className="rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#075E54]/10 backdrop-blur-xl p-4">
                <MapPin className="mb-3 size-6 text-[#075E54]" />
                <p className="text-sm font-semibold">{siteConfig.branchAreaName}</p>
                <p className="mt-1 text-xs text-[#70847D]">Primary location</p>
              </div>
              <div className="rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#075E54]/10 backdrop-blur-xl p-4">
                <ShieldCheck className="mb-3 size-6 text-[#075E54]" />
                <p className="text-sm font-semibold">Measured fitting</p>
                <p className="mt-1 text-xs text-[#70847D]">For each opening</p>
              </div>
              <div className="rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#075E54]/10 backdrop-blur-xl p-4">
                <Clock className="mb-3 size-6 text-[#075E54]" />
                <p className="text-sm font-semibold">Site check</p>
                <p className="mt-1 text-xs text-[#70847D]">Before fitting</p>
              </div>
            </div>
          </div>
      ...
      <section className="px-6 py-16 md:px-10">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          <div>
            ...
            <p className="mt-4 text-sm leading-7 text-[#536761]">
              Choose the service and area to open the matching Bangalore page.
            </p>
            <Link
              href="/bangalore/"
              className="mt-6 inline-flex min-h-[44px] items-center justify-center rounded-lg border border-white/70 bg-white/70 backdrop-blur-xl px-5 py-2 text-sm font-semibold text-[#075E54] transition hover:bg-white"
            >
