        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#075E54]/10 backdrop-blur-xl p-5">
              <ShieldCheck className="mb-4 size-7 text-[#075E54]" />
              <p className="text-3xl font-extrabold">Core</p>
              <p className="mt-1 text-sm text-[#536761]">Main work lines</p>
            </div>
            <div className="rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#075E54]/10 backdrop-blur-xl p-5">
              <MapPin className="mb-4 size-7 text-[#075E54]" />
              <p className="text-3xl font-extrabold">{siteConfig.city}</p>
              <p className="mt-1 text-sm text-[#536761]">Service coverage</p>
            </div>
            <div className="rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#075E54]/10 backdrop-blur-xl p-5 sm:col-span-2">
              <Sparkles className="mb-4 size-7 text-[#075E54]" />
              <p className="text-3xl font-extrabold">
                {siteConfig.branchAreaName}
              </p>
              <p className="mt-1 text-sm text-[#536761]">
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {services.map((service) => (
              <Link
                ...
                className="rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#075E54]/10 backdrop-blur-xl p-5 transition hover:border-[#075E54]/40"
              >
        ...
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          ...
          <div className="grid gap-3">
            {strengths.map((item) => (
              <div
                key={item}
                className="flex items-start gap-3 rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#075E54]/10 backdrop-blur-xl p-4"
              >
