        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/bangalore/"
                className="inline-flex min-h-[44px] items-center justify-center rounded-lg bg-[#0369A1] px-5 py-2 text-sm font-semibold text-white shadow-[0_10px_35px_rgba(14,165,233,0.12)] transition hover:bg-[#075985]"
              >
                View Bangalore Services
              </Link>
              <Link
                href="/gallery/"
                className="inline-flex min-h-[44px] items-center justify-center rounded-lg border border-white/70 bg-white/70 backdrop-blur-xl px-5 py-2 text-sm font-semibold text-[#0369A1] transition hover:bg-[#E0F2FE]"
              >
                View Gallery
              </Link>
            </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#0369A1]/10 backdrop-blur-xl p-5">
              <ShieldCheck className="mb-4 size-7 text-[#0369A1]" />
              <p className="text-3xl font-extrabold">Core</p>
              <p className="mt-1 text-sm text-[#475569]">Main work lines</p>
            </div>
            <div className="rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#0369A1]/10 backdrop-blur-xl p-5">
              <MapPin className="mb-4 size-7 text-[#0369A1]" />
              <p className="text-3xl font-extrabold">{siteConfig.city}</p>
              <p className="mt-1 text-sm text-[#475569]">Service coverage</p>
            </div>
            <div className="rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#0369A1]/10 backdrop-blur-xl p-5 sm:col-span-2">
              <Sparkles className="mb-4 size-7 text-[#0369A1]" />
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {services.map((service) => (
              <Link
                ...
                className="rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#0369A1]/10 backdrop-blur-xl p-5 transition hover:border-[#0369A1]/40"
              >
        ...
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          ...
          <div className="grid gap-3">
            {strengths.map((item) => (
              <div
                key={item}
                className="flex items-start gap-3 rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#0369A1]/10 backdrop-blur-xl p-4"
              >
