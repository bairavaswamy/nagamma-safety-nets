        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div className="rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#0369A1]/10 backdrop-blur-xl p-5">
            <div className="mb-5 flex items-start gap-3">
              <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-[#0369A1] text-white">
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {cardsData.map((service) => (
              <Link
                key={service.title}
                href={service.href}
                className="group overflow-hidden rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#0369A1]/10 backdrop-blur-xl transition hover:border-[#0369A1]/40"
              >
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  />
                  <span className="absolute left-3 top-3 rounded-lg bg-white/45 px-3 py-1 text-xs font-semibold text-[#0369A1] shadow-sm">
                    {service.badge}
                  </span>
                </div>
                <div className="p-5">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {service.tags.map((tag) => (
                      <span
                        key={tag}
                        className="rounded-lg bg-[#EAF6FF] px-2.5 py-1 text-xs font-medium text-[#0369A1]"
                      >
                        {tag}
                      </span>
                    ))}
                  </div>
                  <p className="mt-5 text-sm font-semibold text-[#0369A1]">
                    See details
                  </p>
                </div>
              </Link>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {areas.map((area) => (
              <div
                key={area.slug}
                className="rounded-lg border border-white/70 bg-white/70 shadow-xl shadow-[#0369A1]/10 backdrop-blur-xl p-4"
              >
